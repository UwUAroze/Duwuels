...
public class SumoDuel {
    ...
    public static void continueSynchronously(Location arenaMiddle, Player player1, Player player2) {
        ...
        player1.sendTitle(ChatUtils.color("&7Found an opponent: &c" + player2), ChatUtils.color("&7The game will begin shortly. &aGood Luck!"), 5, 10, 5);
        player2.sendTitle(ChatUtils.color("&7Found an opponent: &c" + player1), ChatUtils.color("&7The game will begin shortly. &aGood Luck!"), 5, 10, 5);

        Bukkit.getScheduler().runTaskLater(Duwuels.getInstance(), () -> {
            player1.sendTitle(ChatUtils.color("&7Starting in &63..."), ChatUtils.color("&7Opponent: &c" + player2.getName()), 5, 5, 0);
            player2.sendTitle(ChatUtils.color("&7Starting in &63..."), ChatUtils.color("&7Opponent: &c" + player1.getName()), 5, 5, 0);
        }, 20);

        Bukkit.getScheduler().runTaskLater(Duwuels.getInstance(), () -> {
            player1.sendTitle(ChatUtils.color("&7Starting in &e2..."), ChatUtils.color("&7Opponent: &c" + player2.getName()), 0, 10, 0);
            player2.sendTitle(ChatUtils.color("&7Starting in &e2..."), ChatUtils.color("&7Opponent: &c" + player1.getName()), 0, 10, 0);
        }, 40);
