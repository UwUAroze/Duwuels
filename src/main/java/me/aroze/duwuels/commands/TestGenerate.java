    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        ...
        for (int a = 0; a <= 8; a++) {
            for (int b = 0; b <= 8; b++) {
                ...
                player.getWorld().spawnFallingBlock(start.clone().add(a, 25, b), Material.PINK_CONCRETE, (byte) 0);
            }
        }
        ...
        for (int z = 0; z <= 10; z=z+10) {
            for (int x = 0; x < 7; x++) {
                ...
                player.getWorld().spawnFallingBlock(start2.clone().add(x, 25, z), Material.PINK_CONCRETE, (byte) 0);
            }
        }
        ...
        for (int x = 0; x <= 10; x=x+10) {
            for (int z = 0; z < 7; z++) {
                ...
                player.getWorld().spawnFallingBlock(start3.clone().add(x, 25, z), Material.PINK_CONCRETE, (byte) 0);
            }
        }
